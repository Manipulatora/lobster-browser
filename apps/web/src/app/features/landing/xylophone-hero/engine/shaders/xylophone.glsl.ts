/**
 * Shaders for the instanced glass bars — adapted from Sujen Phea's WebGL Xylophone (MIT),
 * https://github.com/Sujenphea/xylophone. Unchanged from the source: neither shader references
 * the SSAO view-normal buffer, which this port drops (see xylophone-engine.ts).
 */

export const xylophoneVert = `
