 ...
 *
 * The marks are inlined as SVG so the buttons carry no network cost and no external asset. The
 * providers are not wired yet — these are inert `type="button"` controls until the OAuth
...
@Component({
  ...
  template: `
    <div class="flex flex-col gap-3">
      <button type="button" class="btn btn-md btn-secondary w-full">
